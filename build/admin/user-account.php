...
if(isset($_POST['submit']))
{
  ...
  $check_query = mysqli_query($conn,"SELECT * FROM accounts WHERE email='$email'");
  ...
  {
    mysqli_query($conn, "INSERT INTO accounts (`name`,`email`,`password`,`type`) VALUES ('$name','$email','$password','$type')") or die(mysqli_error($conn));
